...
function Matches() {
  ...
  return (
    <section id="matches" className="flex-col justify-center items-center  w-[100dvw] h-auto ">
      ...
      {/* list of upcomming matches  */}
         <div className="flex  justify-center items-center  w-full h-[15vmax] mb-6 ">
          ...
          <div className="flex flex-col h-full justify-end pb-5 gap-1 items-center ">
            <h1 className="text-[2vw]    font-robert-regular text-6xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,0,0,0.8)] tracking-widest">{time}</h1>
             <p className="font-robert-regular bold text-[0.7vmax]">{date}</p>
            <div className="flex justify-center items-center gap-2  ">
              <TiSocialYoutube className= "  w-4    h-4  md:w-5    md:h-5   transition-transform duration-300 ease-in-out hover:scale-110 cursor-pointer"/>
              <PiTwitchLogoBold className= "  w-4 h-4  md:w-5    md:h-5 transition-transform duration-300 ease-in-out hover:scale-110 cursor-pointer" />
            </div>
      ...
      {/* 2 */}
       <div className="flex  justify-center items-center  w-full h-[15vmax] mb-6 ">
          ...
          <img src={teamLogo4} alt="#teamLogo" className="w-[60] h-[60%] absolute top-0 left-0 z-30 object-contain" />
          </div>
          <div className="flex flex-col h-full justify-end pb-5 gap-1 items-center ">
            <h1 className="text-[2vw]    font-robert-regular text-6xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,0,0,0.8)] tracking-widest">{time}</h1>
             <p className="font-robert-regular bold text-[0.7vmax]">{date}</p>
          ...
          <img src={teamLogo3} alt="#teamLogo" className="w-[60] h-[60%] absolute top-0 right-0  z-30 object-contain" />
      ...
      {/* 3 */}
       <div className="flex  justify-center items-center  w-full h-[15vmax] mb-6 ">
          ...
          <img src={teamLogo5} alt="#teamLogo" className="w-[60] h-[60%] absolute top-0 left-0 z-30 object-contain" />
          </div>
          <div className="flex flex-col h-full justify-end pb-5 gap-1 items-center ">
            <h1 className="text-[2vw]    font-robert-regular text-6xl font-bold text-white drop-shadow-[0_0_10px_rgba(255,0,0,0.8)] tracking-widest">{time}</h1>
             <p className="font-robert-regular bold text-[0.7vmax]">{date}</p>
          ...
          <img src={teamLogo6} alt="#teamLogo" className="w-[60] h-[60%] absolute top-0 right-0  z-30 object-contain" />
